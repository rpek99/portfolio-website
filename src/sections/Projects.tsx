            ...
            <div className='max-w-[1240px] mx-auto'>
                ...
                <div className='grid md:grid-cols-2 gap-8'>
                    <div className='bg-white shadow-xl rounded-lg overflow-hidden'>
                        <Image src="https://user-images.githubusercontent.com/66913935/193622673-f2b67c9f-0cb6-4010-be14-9eb02ba41ffe.png" alt="NFT Marketplace" width={600} height={192} className='w-full h-48 object-cover' />
                        <div className='p-6'>
                    ...
                    <div className='bg-white shadow-xl rounded-lg overflow-hidden'>
                        <Image src="https://user-images.githubusercontent.com/66913935/193624877-e4419782-ee60-4d2e-80f3-de9f8695c390.png" alt="Shopping App" width={600} height={192} className='w-full h-48 object-cover' />
                        <div className='p-6'>
                    ...
                    <div className='bg-white shadow-xl rounded-lg overflow-hidden'>
                        <Image src="https://user-images.githubusercontent.com/66913935/193650825-c2317af6-754d-49b9-8238-52c14cab723d.png" alt="Jewelery Shopping App" width={600} height={192} className='w-full h-48 object-cover' />
                        <div className='p-6'>
